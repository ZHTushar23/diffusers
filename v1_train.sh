#!/bin/bash 
#SBATCH --job-name=v1DFtrain       # Job name
...
#SBATCH --error=v1_ddpm.err                # Error file name
#SBATCH --output=v1_ddpm.out               # Output file name


export CUDA_LAUNCH_BLOCKING=1
torchrun --standalone --nnodes=1 --nproc-per-node=4 v1_train.py