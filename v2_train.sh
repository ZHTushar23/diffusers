#!/bin/bash 
#SBATCH --job-name=v2DFtrain       # Job name
...
#SBATCH --error=v2_ddpm.err                # Error file name
#SBATCH --output=v2_ddpm.out               # Output file name


export CUDA_LAUNCH_BLOCKING=1
torchrun --standalone --nnodes=1 --nproc-per-node=4 v2_train.py