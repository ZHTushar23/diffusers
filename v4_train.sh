#!/bin/bash 
#SBATCH --job-name=v4DFtrain       # Job name
...
#SBATCH --error=v4_ddpm.err                # Error file name
#SBATCH --output=v4_ddpm.out               # Output file name


export CUDA_LAUNCH_BLOCKING=1
torchrun --standalone --nnodes=1 --nproc-per-node=4 v4_train.py